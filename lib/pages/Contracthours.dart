...
class _AddressPageState extends State<AddressPage> {
  ...
  void uploadItem() {
    ...
    Navigator.push(
      context,
     MaterialPageRoute(
        builder: (context) => ChessBaka(addressData: addressData),
     ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          mainAxisAlignment: MainAxisAlignment.end, // لضمان ظهور النص على اليمين
          children: [
            Flexible( // لضمان عدم خروج النص عن حدود الشاشة
              child: Text(
                "أضف عنوان",
               style:AppWidget.TitlePap(),
                overflow: TextOverflow.ellipsis, // لإضافة نقاط الحذف إذا كان النص طويلًا جدًا
              ),
            ),
          ],
        ),
